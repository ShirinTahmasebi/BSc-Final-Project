...
public class ButtonFloat extends RelativeLayout {
    ...
    int backgroundColor = R.color.accent;
    ...
    public ButtonFloat(Context context, AttributeSet attrs) {
        ...
        shape.setColor(getResources().getColor(R.color.accent));

        post(new Runnable() {

            @Override
            public void run() {
                showPosition = ViewHelper.getY(ButtonFloat.this) - Utils.dpToPx(10, getResources());
