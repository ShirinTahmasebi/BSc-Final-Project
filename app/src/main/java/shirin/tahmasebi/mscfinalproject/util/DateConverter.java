...
public class DateConverter {
  ...
  */
  ...
  /***
   * DateConverter:
   * This constructor receives a Calendar object and initializes the other private
   * members of the class accordingly.
   * @param date util.Calendar
   */
  public DateConverter(Calendar date) {
    setGregorianDate(date.get(Calendar.YEAR), date.get(Calendar.MONTH), date.get(Calendar.DAY_OF_MONTH));
  }

  /***
   * DateConverter:
   * This constructor receives a long value as time in millis and initializes the other private
   * members of the class accordingly.
   * @param timeInMillis long
   */
  public DateConverter(long timeInMillis) {
